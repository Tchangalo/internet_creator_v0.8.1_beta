...
# if [[ $fr == $lr ]]; then
# 	echo -e "${C}Restart of router p${provider}r${fr}v executed successfully!${NC}"
# else
# 	echo -e "${C}Restart of routers p${provider}r${fr}v to p${provider}r${lr}v executed successfully!${NC}"
# fi